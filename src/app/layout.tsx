...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        {/*
          The `sora.variable` class is a Tailwind CSS class that sets the font
          family to the Sora font. This class is generated by the `Sora` function
          from the `next/font/google` module.
